...
# }
dashcam_vehicle_info = {
  1:  "Facing Each Other Going Straight, dashcam vehicle, penguins",
  2:  "Following Vehicle Going Straight After Leaving Safety Zone, dashcam vehicle, paperclips",
  3:  "Following Vehicle Going Straight Right Side Of Lane, dashcam vehicle, umbrellas",
  4:  "Going Straight From Left Road, dashcam vehicle, board games",
  5:  "Going Straight From Main Road, dashcam vehicle, teabags",
  6:  "Going Straight From Main Road Entered Earlier, dashcam vehicle, triangles",
  7:  "Going Straight From Main Road Entered Later, dashcam vehicle, crayons",
  8:  "Going Straight From Right Road, dashcam vehicle, sudoku",
  9:  "Going Straight From Side Road Left, dashcam vehicle, lighthouses",
  10: "Going Straight From Side Road Right, dashcam vehicle, spoons",
  11: "Going Straight From The Right, dashcam vehicle, cloud types",
  12: "Going Straight From The Right Entered Earlier, dashcam vehicle, dragons",
  13: "Going Straight From The Right Entered Later, dashcam vehicle, pencil grades",
  14: "Going Straight Lane Change Inside Intersection, dashcam vehicle, elevator music",
  15: "Green Light Going Straight, dashcam vehicle, lemonade",
  16: "Green Light Going Straight Collided With Red Light Vehicle, dashcam vehicle, prime numbers",
  17: "Left Turn From Right Road, dashcam vehicle, carpets",
  18: "Left Turn From Side Road, dashcam vehicle, map icons",
  19: "Right Turn, dashcam vehicle, teapot haiku",
  20: "Right Turn Entered Earlier, dashcam vehicle, window blinds",
  21: "Right Turn Entered Later, dashcam vehicle, toast levels",
  22: "Right Turn From Main Road, dashcam vehicle, cassette tapes",
  23: "Right Turn From Main Road Entered Later, dashcam vehicle, color names",
  24: "Right Turn From Side Road, dashcam vehicle, paper sizes",
  25: "Right Turn From Side Road Entered Earlier, dashcam vehicle, pillows",
  26: "Right Turn From Side Road Entered Later, dashcam vehicle, snowflakes",
  27: "Right Turn Right Lane, dashcam vehicle, notebook margins",
  28: "Simultaneous Lane Change, dashcam vehicle, chess openings",
  29: "Yellow Light Going Straight, dashcam vehicle, rain playlist",
  30: "Yellow Light Left Turn Collided With Red Light Vehicle, dashcam vehicle, rubber ducks"
}

other_vehicle_info = {
  1:  "Departing After Stop, other vehicle, candle scents",
  2:  "Facing Each Other Going Straight, other vehicle, cloud puns",
  3:  "Following Vehicle Going Straight, other vehicle, paper texture",
  4:  "Following Vehicle Going Straight Left Side Of Lane, other vehicle, cereal mascots",
  5:  "Following Vehicle Going Straight Right Side Of Lane, other vehicle, towel folds",
  6:  "Going Straight From Left Road, other vehicle, tomato soup",
  7:  "Going Straight From Main Road, other vehicle, marble swirls",
  8:  "Going Straight From Main Road Entered Earlier, other vehicle, palindromes",
  9:  "Going Straight From Main Road Entered Later, other vehicle, paper airplanes",
  10: "Going Straight From Right Road, other vehicle, reverse months",
  11: "Going Straight From Side Road Left, other vehicle, sock drawers",
  12: "Going Straight From Side Road Right, other vehicle, fake constellations",
  13: "Going Straight From The Right, other vehicle, staplers",
  14: "Going Straight From The Right Entered Earlier, other vehicle, hexagons",
  15: "Going Straight From The Right Entered Later, other vehicle, string knots",
  16: "Green Left Turn Signal Left Turn Collided With Red Light Vehicle, other vehicle, noodles",
  17: "Green Light Going Straight, other vehicle, alphabetized fruit",
  18: "Left Turn From Right Road, other vehicle, sci-fi planets",
  19: "Left Turn From Side Road, other vehicle, wallpaper",
  20: "Right Turn, other vehicle, bookmark designs",
  21: "Right Turn Entered Earlier, other vehicle, cloud shades",
  22: "Right Turn Entered Later, other vehicle, nap durations",
  23: "Right Turn From Main Road, other vehicle, lavender vs. lilac",
  24: "Right Turn From Main Road Entered Earlier, other vehicle, pencil shavings",
  25: "Right Turn From Main Road Entered Later, other vehicle, chess pieces",
  26: "Right Turn From Side Road, other vehicle, tea list",
  27: "Right Turn From Side Road Entered Later, other vehicle, shoelace knots",
  28: "Right Turn Right Lane, other vehicle, tassels"
}
